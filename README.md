# Events PWA - Modular Content Architecture

A Progressive Web App designed to manage and display localized event, artist, and setlist data. This project emphasizes a modular data-driven architecture that allows for easy content contribution through standardized templates.

## 🛠 Engineering & DevEx Highlights
* **Progressive Web App (PWA)**: Fully offline-capable implementation with a complete manifest and icon set for mobile installation.
